...
const Cell = forwardRef(({ num, onDie, onReveal, x, y, height = Constants.CELL_SIZE,
    ...
    const content = (isMine ? <Animated.Image source={require('./mine.png')} style={[{ height: Constants.CELL_SIZE, width: Constants.CELL_SIZE, position: 'absolute', resizeMode: 'contain' }, {
        transform: [
            {
